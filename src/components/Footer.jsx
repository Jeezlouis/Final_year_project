    ...
    <div className="bg-[var(--dark-background-color)] code-section">
      <div className="container mx-auto px-6 py-24 xl:px-12 2xl:px-36">
        <div className="grid grid-cols-1 pt-4 md:grid-cols-3 lg:grid-cols-4 lg:space-x-24">
          <div className="mb-8">
            <a href="/" className="mb-8 block text-3xl tracking-wider text-[var(--primary-color)] [font-family:var(--font-family-heading)]">Unitern</a>
            <p className="text-left font-light tracking-wider text-[var(--light-text-color)]">
              Unitern is a sleek and modern internship recruitment platform designed to connect students with companies offering internships and industrial training opportunities.
            </p>
          ...
          <div className="mb-8">
            ...
            <a href="/student-dashboard" className="mb-2 block font-light text-[var(--light-text-color)]">Student Dashboard</a>
            <a href="/employer-dashboard" className="mb-2 block font-light text-[var(--light-text-color)]">Employer Dashboard</a>
          ...
          <div className="mb-8 lg:col-span-2">
            ...
            <div className="mb-2 flex flex-row font-light tracking-wider text-[var(--light-text-color)] items-center">
              <FaEnvelope className="mr-2 w-6 flex-none text-[var(--primary-color)]" aria-hidden="true" /><span className="w-[90%] break-words">info@unitern.com</span>
            </div>
            <div className="mb-2 flex flex-row font-light tracking-wider text-[var(--light-text-color)] items-center">
